...
function Navbar() {
  return (
    <section className='sticky top-0 pt-4 z-20 bg-black grid grid-rows-2 h-2'>
      ...
      <nav className=' bg-white bg-opacity-50 justify-around py-1 px-2 rounded-full h-12 w-2/3  mx-auto border-slate-500'>
        <ul className='justify-evenly flex mx-auto items-center '>
          <li className='text-1xl hover:text-2xl rounded text-white transition ease-in-out delay-100 hover:translate-y-1 hover:scale-110 hover:ring-indigo-500 duration-200'>
            <Link href="#">Home</Link>
          </li>

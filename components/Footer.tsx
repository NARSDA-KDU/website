...
function Footer() {
  ...
  return (
    <div className="relative flex flex-col items-center h-screen px-10 mx-auto text-center text-white md:text-left md:flex-row max-w-7xl justify-evenly " >
...
<div className="flex items-center justify-center space-x-5">
  ...
  <p className="text-2xl " >+09036702209</p>
    </div>
    <div className="flex items-center justify-center space-x-5">
           <div className="text-[#2a4798] h-7 w-7 animate-pulse" ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
  ...
  <p className="text-2xl " >@emmanueltokula03@gmail.com</p>
    </div>
    <div className="flex items-center justify-center space-x-5">
           <div className="text-[#2a4798] h-7 w-7 animate-pulse" ><svg xmlns="http://www.w3.org/2000/svg"
  ...
  <p className="text-2xl " >Abuja Aporesettlement</p>
    </div>
